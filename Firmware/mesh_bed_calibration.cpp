...
#define BED_CALIBRATION_POINT_OFFSET_MAX_EUCLIDIAN  (2.0f) //previously 0.8f, this is for cloned beds
#define BED_CALIBRATION_POINT_OFFSET_MAX_1ST_ROW_X  (2.0f) //0.8f
#define BED_CALIBRATION_POINT_OFFSET_MAX_1ST_ROW_Y  (2.0f) //0.8f
